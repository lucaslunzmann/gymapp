...
export default async function SideNav() {
  ...
  <div className="fixed flex flex-col top-0 left-0 w-64 bg-white h-full border-r">
    <div className="flex h-12 my-2 border-b">
      <SideNavTop />
    </div>
    <div className="overflow-y-auto overflow-x-hidden flex-grow">
      <ul className="flex flex-col py-4 space-y-">
        <li>
        ...
        <li>
          <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-violet-500 pr-6">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">My Gym</span>
          </a>
        </li>
        <li>
          <a href="/dashboard" className="relative flex flex-row items-center h-11 focus:outline-none hover:bg-gray-50 text-gray-600 hover:text-gray-800 border-l-4 border-transparent hover:border-violet-500 pr-6">
            <span className="inline-flex justify-center items-center ml-4">
